...
private:
  ...
  virtual bool OnUserCreate() {
    ...
    starField.Init();
		...
		// Load Fonts
    pixelFont48 = std::make_unique<olc::Font>( "./sprites/vanassistant/font_48.png");
		computerFont20 = std::make_unique<olc::Font>( "./sprites/vanassistant/font_computer_20.png");
		computerFont28 = std::make_unique<olc::Font>( "./sprites/vanassistant/font_computer_28.png");
